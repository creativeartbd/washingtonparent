<?php
/**
 * Template for displaying author post
 *
 * @package everstrap
 */
...
<article <?php post_class( 'home-latest-stories author-post' ); ?> id="post-<?php the_ID(); ?>">

	<?php if ( has_post_thumbnail() ) { ?>
	<div class="post-thumbnail">
		<a href="<?php echo esc_url( get_permalink() ); ?>">
			<?php echo get_the_post_thumbnail( get_the_ID(), 'toc-thumb' ); ?>
		</a>
	</div>
	<?php } ?>
